...
use PHPMailer\PHPMailer\Exception;
 ...
 if (isset($_POST['approve'])) {
        ...
        $body .= '<p style="line-height: 1.5em;">You have succesffuly made a withdraw. $'.number_format($amount, 2).' have been sent to your bitcoin wallet </p>';
        $body .= '<p style="line-height: 1.5em;">Bitcoin wallet:'.$row -> wallet_address.'</p>';
        $body .= '<p>Withdraw Id:'.$id.'</p>';
        $body .= '<p>Amount: $'.number_format($amount, 2).'</p>';
        $body .= "<p>Don't forget to refer your friends to Elite-pay Investment and earn$ ".$row -> referral_bonus." % of
        all their deposits forver.</p>";
        $body .= '<p style="line-height: 1.5em;">To invite them, simply copy the referral link in your dashboard and send to them.
        Once they register with your referral, you get'.$row -> referral_bonus.'%
        of any amount they deposit straight to your account.
        </p>';
